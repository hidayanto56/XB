<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Account/Acc.Master" AutoEventWireup="true" CodeBehind="ChangePass.aspx.cs" Inherits="XB.Account.ChangePass" %>
            ...
            <table cellpadding="1" cellspacing="0" style="border-collapse:collapse;">
                <tr>
                    <td>
                        <table cellpadding="0">
                            <tr>
                                <td align="center" colspan="2" style="color:White;background-color:#6B696B;font-weight:bold;">Change Password Complete</td>
                            </tr>
                            <tr>
